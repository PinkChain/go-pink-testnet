...
Section "Geth" GETH_IDX
  ...
  SimpleFC::AdvRemoveRule "Geth incoming peers (TCP:30603)"
  SimpleFC::AdvRemoveRule "Geth outgoing peers (TCP:30603)"
  SimpleFC::AdvRemoveRule "Geth UDP discovery (UDP:30603)"

  # Firewall - add rules
  SimpleFC::AdvAddRule "Geth incoming peers (TCP:30603)" ""  6 1 1 2147483647 1 "$INSTDIR\geth.exe" "" "" "Ethereum" 30603 "" "" ""
  SimpleFC::AdvAddRule "Geth outgoing peers (TCP:30603)" ""  6 2 1 2147483647 1 "$INSTDIR\geth.exe" "" "" "Ethereum" "" 30603 "" ""
  SimpleFC::AdvAddRule "Geth UDP discovery (UDP:30603)" "" 17 2 1 2147483647 1 "$INSTDIR\geth.exe" "" "" "Ethereum" "" 30603 "" ""
